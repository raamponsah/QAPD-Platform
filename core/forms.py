...
class EvaluationForm(ModelForm):
    class Meta:
        ...
        #
        widgets = {
            'curriculum_feedback_beginning_answer': RadioSelect(attrs={'class': 'form-check-input'}),
            'curriculum_feedback_course_answer': RadioSelect(attrs={'class': 'form-check-input'}),
            'curriculum_feedback_lecture_answer': RadioSelect(attrs={'class': 'form-check-input'}),
            'curriculum_feedback_outcomes_answer': RadioSelect(attrs={'class': 'form-check-input'}),
            'curriculum_feedback_procedures_answer': RadioSelect(attrs={'class': 'form-check-input'}),
            'curriculum_feedback_books_answer': RadioSelect(attrs={'class': 'form-check-input'}),

            'attendance_schedule': RadioSelect(attrs={'class': 'form-check-input'}),
            'attendance_punctuality': RadioSelect(attrs={'class': 'form-check-input'}),
            'attendance_presence': RadioSelect(attrs={'class': 'form-check-input'}),

            'delivery_enthusiasm': RadioSelect(attrs={'class': 'form-check-input'}),
            'delivery_sequence': RadioSelect(attrs={'class': 'form-check-input'}),
            'delivery_organization': RadioSelect(attrs={'class': 'form-check-input'}),
            'delivery_clarity': RadioSelect(attrs={'class': 'form-check-input'}),
            'delivery_contents': RadioSelect(attrs={'class': 'form-check-input'}),
            'delivery_responsiveness': RadioSelect(attrs={'class': 'form-check-input'}),
            'delivery_achievements': RadioSelect(attrs={'class': 'form-check-input'}),
            'delivery_innovation': RadioSelect(attrs={'class': 'form-check-input'}),
            'delivery_theory_practices': RadioSelect(attrs={'class': 'form-check-input'}),

            'assignments_relevance': RadioSelect(attrs={'class': 'form-check-input'}),
            'assignments_promptitude': RadioSelect(attrs={'class': 'form-check-input'}),
            'assignments_feedback': RadioSelect(attrs={'class': 'form-check-input'}),
            'assignments_guidance': RadioSelect(attrs={'class': 'form-check-input'}),

            'interaction_availability': RadioSelect(attrs={'class': 'form-check-input'}),
            'interaction_help': RadioSelect(attrs={'class': 'form-check-input'}),
            'interaction_fairness': RadioSelect(attrs={'class': 'form-check-input'}),

            'environment_classroom_size': RadioSelect(attrs={'class': 'form-check-input'}),
            'environment_seats': RadioSelect(attrs={'class': 'form-check-input'}),
            'environment_audio_visual_equip': RadioSelect(attrs={'class': 'form-check-input'}),
            'environment_public_address': RadioSelect(attrs={'class': 'form-check-input'}),
            'environment_books': RadioSelect(attrs={'class': 'form-check-input'}),
            'environment_computers': RadioSelect(attrs={'class': 'form-check-input'}),
